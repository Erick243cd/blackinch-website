...
<head>
    ...
    <!-- tag input css -->
    <link rel="stylesheet" href="<?= site_url() ?>public/assets/es_admin/css/plugins/bootstrap-tagsinput.css">
    <!-- data tables css -->
    <link rel="stylesheet" href="<?= site_url() ?>public/assets/es_admin/css/plugins/dataTables.bootstrap4.min.css">
    <!-- select2 css -->
    <link rel="stylesheet" href="<?= site_url() ?>public/assets/es_admin/css/plugins/select2.min.css">
    <link rel="stylesheet" href="<?= site_url() ?>public/assets/es_admin/css/formulaire.css">
        ...
        <div class="navbar-content scroll-div">
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item pcoded-hasmenu">
                    <a href="<?= site_url() ?>dashboard" class="nav-link "><span class="pcoded-micon"><i
                ...
                <?php if ($user_data['u_role'] === 'admin'): ?>
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li><a href="<?= site_url() ?>add-user">Ajouter Utilisateur</a></li>
                            <li><a href="<?= site_url() ?>list-users"">Liste Utilisateurs</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                <li class="nav-item pcoded-hasmenu">
                    <a href="<?= site_url() ?>profile" class="nav-link "><span class="pcoded-micon"><i
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="<?= site_url() ?>public/assets/es_admin/images/user/<?= $user_data['u_picture'] /*?? "user-default-avatar.png"*/ ?>"
                                 class="img-radius" alt="pix">
                            <span><?= ucfirst($user_data['u_firstname']) ?? "" ?></span>
                            <a href="<?= site_url() ?>logout" class="dud-logout" title="Déconnexion">
